...
public abstract class SupplicantActivity extends Activity {
	...
	protected String[] getLoginParams(String id) {
		...
		// TODO change counter
		String count = String.valueOf(mss.getSignatureIndex());
		
		Log.i("CASH", "SupplicantActivity.getLoginParams count="+count);
		
		String session_key = mss.symmetric_keyGen();
		
		Log.i("CASH", "APAGAR after: mss.symmetric_keyGen()");
